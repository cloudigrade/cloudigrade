...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--force', action='store_true', help=_(
            'force load definitions even if some are already present'
        ))
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(_(
            'Async task launched to load EC2 instance definitions.'
        ))
