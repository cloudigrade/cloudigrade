...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        user1clount1image1 = account_helper.generate_aws_image(
            owner_aws_account_id=int(
                user1clount1.content_object.aws_account_id
            ),
        )

        user1clount2image1 = account_helper.generate_aws_image(
            owner_aws_account_id=int(
                user1clount2.content_object.aws_account_id
            ),
            rhel_detected=True,
        ...
        user2clount1image1 = account_helper.generate_aws_image(
            owner_aws_account_id=int(
                user2clount1.content_object.aws_account_id
            ),
        )
        ...
        account_helper.generate_aws_instance_events(
            ...
            powered_times=[
                (fifty_five_days, forty_five_days), (one_day, None)
            ],
        )
        account_helper.generate_aws_instance_events(
